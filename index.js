...
const serviceAccount = require("./smart-deals-16691-firebase-adminsdk-fbsvc-880432f55f.json");
...
async function run() {
  try {
    ...
    app.get("/products/bids/:productId",verifyFirebasToken, async (req, res) => {
